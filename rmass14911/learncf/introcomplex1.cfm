...
<hr/>
<p>Some people who have used other programming langages look at the tags above and ask, &quot;Isn't that alot of typing? Isn't there a shorthand method to making objects????&quot;. The answer is &quot;yes&quot;. That is alot of typing. Because of that, ColdFusion has implemented a shorthand to create structures. To use that shorthand, would look like this: </p>
<p>&lt;cfset myMovie={</p>
<p>&nbsp;&nbsp;&nbsp;cast:{</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tim: &quot;Brad Pitt&quot;,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grace:"Stacy Dash"</p>
<p>&nbsp;&nbsp;&nbsp;},</p>
<p>&nbsp;&nbsp;&nbsp;Sets:{</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lowell:{</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Address1:&quot;1 University Ave&quot;</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</p>
<p>}&gt;</p>

<p>Let's walk through that. The &lt;cfset mymovie= says we're going to create a variable called myMovie.</p>
<p>The { character says we are going to start a new object/structure.</p>
<p>The keys and values are seperated by a : (colon) as in Tim:"Brad Pitt".</p>
<p>Different keys/value pairs are seperated by a comma (,) as in between the two actors and the cast and set objects. </p>
<p>The } signifies the end of the object/struct.</p>

<p>Two ways to do the same thing.</p>